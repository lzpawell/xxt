package bid.xiaocha.xxt.ui.views;
 ...
 */
public class StarAppraiseView extends LinearLayout {
    ...
    public StarAppraiseView(Context context) {
        super(context);
    }

    public StarAppraiseView(Context context, AttributeSet attrs) {
        super(context, attrs);
