...
@MessageTag(value = RongManager.ACCEPT_ORDER_MESSAGE,flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED )
public class AcceptOrderMessage extends MessageContent {
    ...
    public AcceptOrderMessage(byte[] data){
        String jsonStr = null;
        try {
    ...
    public AcceptOrderMessage(Parcel in){
    ...
    public static final Creator<AcceptOrderMessage> CREATOR = new Creator<AcceptOrderMessage>() {

        @Override
        public AcceptOrderMessage createFromParcel(Parcel source) {
            return new AcceptOrderMessage(source);
        }

        @Override
        public AcceptOrderMessage[] newArray(int size) {
            return new AcceptOrderMessage[size];
        }
    };
