...
@MessageTag(value = RongManager.REFUSE_CANCEL_ORDER_MESSAGE,flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED )
public class RefuseCancelOrderMessage extends MessageContent {
    private String title;
    private String senderNickname;
    private int serveType;
    private String orderId;
    private String senderId;
    public RefuseCancelOrderMessage(){}
    public RefuseCancelOrderMessage(byte[] data){
        String jsonStr = null;
        try {
    ...
    public RefuseCancelOrderMessage(Parcel in){
    ...
    public static final Creator<RefuseCancelOrderMessage> CREATOR = new Creator<RefuseCancelOrderMessage>() {

        @Override
        public RefuseCancelOrderMessage createFromParcel(Parcel source) {
            return new RefuseCancelOrderMessage(source);
        }

        @Override
        public RefuseCancelOrderMessage[] newArray(int size) {
            return new RefuseCancelOrderMessage[size];
        }
    };
