...
@MessageTag(value = RongManager.FINISH_ORDER_MESSAGE,flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED )
public class FinishOrderMessage extends MessageContent {
    ...
    public FinishOrderMessage(byte[] data){
        String jsonStr = null;
        try {
    ...
    public FinishOrderMessage(Parcel in){
    ...
    public static final Creator<FinishOrderMessage> CREATOR = new Creator<FinishOrderMessage>() {

        @Override
        public FinishOrderMessage createFromParcel(Parcel source) {
            return new FinishOrderMessage(source);
        }

        @Override
        public FinishOrderMessage[] newArray(int size) {
            return new FinishOrderMessage[size];
        }
    };
